...
<div id='mercurius-home'>
  <div id='header'>
    ...
    <div id='buttons'>
      <button class='button is-small is-white' @click='refresh()'><b-icon icon='refresh'></b-icon></button>
      <button class='button is-small is-white' :disabled='!anyActive' @click='download()'><b-icon icon='download'></b-icon></button>
    </div>
  </div>
